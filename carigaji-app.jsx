...
const TRANSLATIONS = {
  ...
  zh: {
    ...
    "landing.trustEscrowTitle": "资金实际存管，而非空口承诺",
    "landing.trustEscrowBody": "薪资在班次开始前即已存入 CariGaji — 而不是雇主开出的空头支票。",
    ...
    "landing.sampleEscrowNote": "雇主已存入 RM 96.00，由 CariGaji 保管，直到您的工时获得确认为止。",
    "landing.sampleSealLine1": "SSM",
