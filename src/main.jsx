...
const renderConfigError = (message) => {
  root.render(
    <div style={{
      ...
      <div style={{ maxWidth: 520, background: "#fff", border: "1px solid #F1C7BC", borderRadius: 16, padding: 24, boxShadow: "0 12px 40px rgba(0,0,0,0.08)" }}>
        <h1 style={{ margin: "0 0 12px", fontSize: 24, lineHeight: 1.2 }}>CariGaji is not configured</h1>
        <p style={{ margin: 0, fontSize: 15, lineHeight: 1.6, color: "#4B5563" }}>{message}</p>
      </div>
    </div>
  );
};
